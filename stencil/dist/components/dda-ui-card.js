import { p as proxyCustomElement, H, d as createEvent, h, c as Host } from './p-4928c8aa.js';

const ddaUiCardCss = ":host{display:block}";
const DdaUiCardStyle0 = ddaUiCardCss;

const DdaUiCard$1 = /*@__PURE__*/ proxyCustomElement(class DdaUiCard extends H {
    constructor() {
        super();
        this.__registerHost();
    ...
    static get style() { return DdaUiCardStyle0; }
}, [4, "dda-ui-card", {
        "type": [1],
        "icon": [1],
        "image": [1],
...
function defineCustomElement$1() {
    ...
    const components = ["dda-ui-card"];
    components.forEach(tagName => { switch (tagName) {
        case "dda-ui-card":
            if (!customElements.get(tagName)) {
                customElements.define(tagName, DdaUiCard$1);
            }
            break;
    } });
}
...
const DdaUiCard = DdaUiCard$1;
const defineCustomElement = defineCustomElement$1;

export { DdaUiCard, defineCustomElement };

//# sourceMappingURL=dda-ui-card.js.map