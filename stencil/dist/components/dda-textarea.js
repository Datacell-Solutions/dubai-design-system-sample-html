...
const DdaTextarea$1 = /*@__PURE__*/ proxyCustomElement(class DdaTextarea extends H {
    constructor() {
        super();
        this.__registerHost();
        this.value = '';
    ...
    get el() { return this; }
    static get style() { return DdaTextareaStyle0 + DdaTextareaStyle1; }
}, [0, "dda-textarea", {
        "placeholder": [1],
        "label": [1],
        "value": [1],
...
function defineCustomElement$1() {
    ...
    const components = ["dda-textarea"];
    components.forEach(tagName => { switch (tagName) {
        case "dda-textarea":
            if (!customElements.get(tagName)) {
                customElements.define(tagName, DdaTextarea$1);
            }
            break;
    } });
}
...
const DdaTextarea = DdaTextarea$1;
const defineCustomElement = defineCustomElement$1;

export { DdaTextarea, defineCustomElement };
