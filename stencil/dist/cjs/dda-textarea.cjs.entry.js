...
const DdaTextarea = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '6bcc22efc8a962cc0a517c0d0dcc860d618e71db' }, index.h("div", { key: 'f793c0e0782db60da1e03d2cba935a6fcff86350', class: textareaClass }, this.label && index.h("label", { key: '880e81c260f59c31fc958b0b6fbd7b3e5c0f6028', htmlFor: this.input_id, class: "dda-input-label" }, this.label), this.enable_rich_editor ? (index.h("div", { id: "editor", class: "dda-richeditor-field" })) : (index.h("textarea", { id: this.input_id, "aria-label": this.aria_label, placeholder: this.placeholder, value: this.value, onInput: (event) => this.handleInput(event), class: "dda-input-field dda-input-textarea", maxLength: this.max_characters })), this.helper_text && (index.h("div", { key: 'a0c0c6d48b982a4aba3bbe28b4f7fbc1a0d7314a', class: "dda-helper-text" }, index.h("span", { key: '51c0e3bfcd476be52cb3970b06455c337439f48b', class: "dda-flex dda-align-center dda-gap-2" }, index.h("i", { key: '2a81691db941652b03c1d9134d5cf749f1af2e8e', class: "material-icons  material-symbols-outlined" }, "info"), " ", this.helper_text), index.h("span", { key: '14b26a00e2bf6be61005f54bab42426f38c1641c', class: "dda-letter-count" }, this.characterCount, " / ", this.max_characters))), this.error_message && (index.h("div", { key: '83b513dcbc0e3e75f4afdb82c028238ef643e3c6', class: "dda-error-message" }, index.h("span", { key: '9da79b7ea9e43c96615c81f9e04485a8c591dac3', class: "dda-flex dda-align-center dda-gap-2" }, index.h("i", { key: 'c93ca46b7d2482770a6980c1c553c81758b29078', class: "material-icons  material-symbols-outlined" }, "info"), " ", this.error_message), index.h("span", { key: 'cca9ba80e06e0f05711cab16dc1e1996ef00cd64', class: "dda-letter-count" }, this.characterCount, " / ", this.max_characters))))));
    }
