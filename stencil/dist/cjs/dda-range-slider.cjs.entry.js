...
const DdaRangeSlider = class {
    ...
    render() {
        return (index.h(index.Host, { key: 'e9afd1fc39873d711a26d1df6cca1295e40b7f4c' }, index.h("div", { key: '8b637585fa69c15366fd482318941a4565afed13', class: `dda-range-slider-container dda-tooltip-${this.tooltip_position} ${this.custom_class} ${this.component_mode}` }, index.h("div", { key: '5d99117d34b701f224991c43b4f966aa1f418266', class: "dda-range-slider" }, index.h("div", { key: 'e404d82a51dded499c072d1001e8e52dffeeb7c7', class: "dda-range-slider-track", style: {
                left: `${this.getPercentage(this.min_value)}%`,
                right: `${100 - this.getPercentage(this.max_value)}%`,
            } }, index.h("span", { key: '111acb90f4d051488448138031940c90a1a7528a', class: "min-label" }, this.min_value, "%"), index.h("span", { key: '7ba4418113fa32ae5a099cd0799cc6fd614cf649', class: "max-label" }, this.max_value, "%")), index.h("label", { key: 'f66dd9d5cc4370e46293015fd10a6aa62650d99e', htmlFor: this.left_input_id }, index.h("input", { key: 'a263746a9dde346a99a452855be254d74bb8ef20', id: this.left_input_id, "aria-label": this.left_aria_label, type: "range", min: this.min, max: this.max, step: this.step, value: this.min_value, onInput: (event) => this.handleMinChange(event), class: "dda-range-slider-input", style: { zIndex: `${this.min_value > this.max - this.min_value ? 5 : 3}` } })), index.h("label", { key: '55a0a05a6a98478de47545d9b3c9da363221a6f6', htmlFor: this.right_input_id }, index.h("input", { key: 'b86ce92eb77fdba473bec04982eff168ff73fa78', id: this.right_input_id, "aria-label": this.right_aria_label, type: "range", min: this.min, max: this.max, step: this.step, value: this.max_value, onInput: (event) => this.handleMaxChange(event), class: "dda-range-slider-input", style: { zIndex: `${this.max_value < this.max - this.min_value ? 5 : 3}` } }))))));
    }
};
